...
class _PassportFormScreenState extends State<PassportFormScreen> {
  ...
  int _ageAtIssue() {
    ...
    if (DateTime(emissao!.year, nascimento!.month, nascimento!.day)
        .isAfter(emissao!)) age--;
    return age;
  }
  ...
  Future<void> _save() async {
    ...
    final doc = DocumentModel(
      ...
      title: 'Passaporte ${_capitalizeWords(nomeCtrl.text.split(' ').first)}',
          ...
          child: Column(children: [
            ...
            _date(
              ...
              (v) {
                final d = _parse(v ?? '');
                if (d == null) return 'Data inválida';
                if (nascimento != null && !d.isAfter(nascimento!)) {
                  return 'Emissão deve ser após nascimento';
                }
            ...
            _date(
              ...
              (v) {
                ...
                final maxDate = DateTime(emissao!.year + maxYears, emissao!.month, emissao!.day)
            ...
            _field(paisOrigemCtrl, 'País de origem', onChanged: (v) {
              paisEmissaoCtrl.text = v;
            }),
